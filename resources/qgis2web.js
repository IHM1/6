...
map.getView().fit([723566.712675, 8540686.332354, 727922.348313, 8543841.736639], map.getSize());
                    ...
                    for (var i=0; i<currentFeatureKeys.length; i++) {
                        if (currentFeatureKeys[i] != 'geometry') {
                            ...
                            if (layer.get('fieldImages')[currentFeatureKeys[i]] != "ExternalResource") {
                                ...
                                popupField += (currentFeature.get(currentFeatureKeys[i]) != null ? '<a href="images/' + currentFeature.get(currentFeatureKeys[i]).replace(/[\\\/:]/g, '_').trim() + '" /" target="blank"><img src="images/' + currentFeature.get(currentFeatureKeys[i]).replace(/[\\\/:]/g, '_').trim() + '" / width="300" height="250"></a></td>' : '');
                            }
                            popupText += '<tr>' + popupField + '</tr>';
                        }
                    }
